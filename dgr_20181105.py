...
>>> exit()
user@epk428-1:~$ nano mbox-short.txt
user@epk428-1:~$ python
Python 3.6.4 |Anaconda, Inc.| (default, Jan 16 2018, 18:10:19) 
[GCC 7.2.0] on linux
Type "help", "copyright", "credits" or "license" for more information.
...
-rw-r--r-- 1 user user   117 Nov  5 16:48  mbox-short.txt
-rw-r--r-- 1 user user 94627 Nov  5 16:53  mbox.txt
